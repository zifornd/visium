...
vector_res_overrep <- lapply(res, parse_res, group = "cluster", p_adj = params$pval.adj.thres.filter, lfc = params$lfc.thres.filter, type= "overrep", 
...
```{r, fig.width = (params$plot_width + 5), fig.height = params$plot_height + 1}
wrap_plots(barplots, ncol = 2)
```
