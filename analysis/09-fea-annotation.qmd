...
res$FUBAR <- res[["Visium_FFPE_Mouse_Brain"]]
res$FUBAR$Sample <- rep("FUBAR", nrow(res$FUBAR))
```
...
if (params$combined_table == TRUE) {
  ...
  # plotFeaDT(resbind_overrep_cells, pageLength = 5, targets = c(8,10))
...
if (params$combined_table == TRUE) {
  ...
  # # Plot as interactive table
  # plotFeaDT(resbind_overrep_hallmarks, pageLength = 5, targets = c(8,10))
...
if (!is.null(custom_genesets_t2g)) {
  ...
  # # Plot as interactive table
  # plotFeaDT(resbind_overrep_custom, pageLength = 5, targets = c(8,10))
...
# plotFeaDT(resbind_gsea_cells, pageLength = 5, targets = c(11, 12))
...
# plotFeaDT(resbind_gsea_hallmarks, pageLength = 5, targets = c(11, 12))
...
if (!is.null(custom_genesets_t2g)) {
  ...
  # plotFeaDT(resbind_gsea_custom, pageLength = 5, targets = c(11, 12))
...
# just need to add a for loop here! Just as in the marker detection! 
# Will need to keep wrap_plots as returns a list! Also need to NOT flatten the results table
# Not flattening will mean will stay in a interesting list heirarchy so we can access it 
