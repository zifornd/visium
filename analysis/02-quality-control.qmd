...
list(
Parameter = "nfeatures_thres",
Value = params$nfeatures_thres,
Description = "nFeatures Threshold for QC filtering."
)
)
...
if (!is.null(params$nfeatures_thres)){
  ...
  # Plot filtered spots
  wrap_plots(lapply(seurat, filterByPlot, threshold = params$nfeatures_thres, by = "nFeatures_Spatial", 
                    direction = "up"))
...
if (!is.null(params$nfeatures_thres)){
  ...
  seurat <- lapply(seurat, filterBy, threshold = params$nfeatures_thres, by = "nFeatures_Spatial", 
                  direction = "up")
