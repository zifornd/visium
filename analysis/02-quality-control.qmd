...
This set of QC values focuses on sequencing QC e.g. total number of reads per sample (`Number.of.Reads`), percentage of valid UMIs (`Valid.UMIs`), the quality of reads and barcodes (`Q30.Bases.in.Barcode`, `Q30.Bases.in.Probe.Read`, `Q30.Bases.in.UMI`) per sample.
...
One violin zooms into the values of each QC measurement, the other enforces a 0 - 100% y axis, and the final includes those with a warning.
...
@fig-qcmappingwarning Summary Violin Plot
