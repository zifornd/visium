...
::: callout-note
Please leave `params$vars.to.regress` as `FALSE` if you do not wish to regress out any additional variables during SCT normalisation.
:::
...
And we can also plot the cell atlas annotation on top of the UMAP we just calculated.
...
list(
Parameter = "seurat",
Value = "[seurat](../../output/11-cell-atlas.rds)",
