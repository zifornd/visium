...
params:
    ...
    marker:
      - "EGFR"
    sample.sheet:
      - "Visium_FFPE_Human_Cervical_Cancer_Samples.csv" # "Visium_FFPE_Mouse_Brain_Samples.csv"
---
...
list(
Parameter = "seurat",
Value = "[seurat](../../output/01-data-loading.rds)",
Description = "Seurat object saved as rds object."
),
list(
Parameter = "metrics",
Value = "[metrics](../../output/metrics.csv)",
