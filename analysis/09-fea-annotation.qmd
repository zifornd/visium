...
Below we perform the hypergeometric sample wise and per `r param$group` if the table is split with `split.res`.
...
@tbl-over-c8 Results for C8:

```{r}
#| code-fold: true
#| tbl-cap: Results for C8 overrepresentation analysis.
#| label: tbl-over-c8
...
@tbl-over-h Results for Hallmark:

```{r}
#| code-fold: true
#| tbl-cap: Results for Hallmark overrepresentation analysis.
#| label: tbl-over-h
...
@tbl-over-custom Results for Custom:

```{r}
#| code-fold: true
#| tbl-cap: Results for Custom overrepresentation analysis.
#| label: tbl-over-custom
...
Below we perform GSEA sample wise and per `r param$group` if the table is split with `split.res`.
...
@tbl-gsea-c8 Results for C8:

```{r}
#| code-fold: true
#| tbl-cap: Results for C8 GSEA analysis.
#| label: tbl-gsea-c8
...
@tbl-gsea-hallmark Results for Hallmark:

```{r}
#| code-fold: true
#| tbl-cap: Results for Hallmark GSEA analysis.
#| label: tbl-gsea-hallmark
...
@tbl-gsea-custom Results for Custom:

```{r}
#| code-fold: true
#| tbl-cap: Results for Custom GSEA analysis.
#| label: tbl-gsea-custom
