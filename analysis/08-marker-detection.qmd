...
if (class(seurat) == "Seurat") { 
  ...
  if (length(unique(seurat@meta.data$Sample)) == 1) {
    ...
    seuratprep$FUBAR <- seuratprep[[unique(seurat@meta.data$Sample)]]
...
#   cat("###", n, "\n")
  ...
  # cat(knitr::knit_print(DT::datatable(res[[n]], class = 'cell-border stripe', extensions = 'Buttons', 
  ...
  # cat(knitr::knit_print(DT::datatable(res[[n]], height = "100%", width = "100%")))
...
list(
Parameter = "seuratprep",
Value = "[seuratprep](../../output/08-marker-detection.rds)",
...
list(
Parameter = "res",
Value = "[res](../../output/08-marker-detection-res.rds)",
