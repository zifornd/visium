...
dimplot(seurat, reduction = "pca", label = FALSE, group.by = "Group", title = "PCA-Integrated")
```
...
featureplot(seurat, reduction = "pca", label = FALSE, feature = "nCount_Spatial", title = "PCA-Integrated")
```
...
featureplot(seurat, reduction = "pca", label = FALSE, feature = "nFeature_Spatial", title = "PCA-Integrated")
```
...
dimplot(seurat_1, reduction = "umap", label = FALSE, group.by = "Group", title = "UMAP-Integrated n.neighbors = 30, min.dist = 0.3")
```
...
dimplot(seurat_2, reduction = "umap", label = FALSE, group.by = "Group", title = "UMAP-Integrated n.neighbors = 5, min.dist = 0.25")
```
...
dimplot(seurat_3, reduction = "umap", label = FALSE, group.by = "Group", title = "UMAP-Integrated n.neighbors = 10, min.dist = 0.1")
```
...
dimplot(seurat_4, reduction = "umap", label = FALSE, group.by = "Group", title = "UMAP-Integrated n.neighbors = 20, min.dist = 0.1")
```
...
dimplot(seurat_5, reduction = "umap", label = FALSE, group.by = "Group", title = "UMAP-Integrated n.neighbors = 10, min.dist = 0.001")
```
...
dimplot(seurat, reduction = "tsne", label = FALSE, group.by = "Group", title = "TSNE-Integrated")
```
...
featureplot(seurat, reduction = "umap", label = FALSE, feature = "nCount_Spatial", title = "UMAP-Integrated")
```
...
featureplot(seurat, reduction = "umap", label = FALSE, feature = "nFeature_Spatial", title = "UMAP-Integrated")
```
...
featureplot(seurat, reduction = "tsne", label = FALSE, feature = "nCount_Spatial", title = "TSNE-Integrated")
```
...
featureplot(seurat, reduction = "tsne", label = FALSE, feature = "nFeature_Spatial", title = "TSNE-Integrated")
```
...
#| fig-cap: UMAP Integrated k.param = 5, resolution = 0.1.

dimplot(seurat_1, reduction = "umap", label = T, group.by = "seurat_clusters", title = "UMAP-Integrated, k.param = 5, resolution = 0.1")
```
k.param = 10, resolution = 0.3
```{r}
#| fig.width: params$plot_width
#| fig.height: (params$plot_height + 1)
#| fig-cap: UMAP Integrated k.param = 10, resolution = 0.3.

dimplot(seurat_2, reduction = "umap", label = T, group.by = "seurat_clusters", title = "UMAP-Integrated, k.param = 10, resolution = 0.3")
```
k.param = 15, resolution = 0.5
```{r}
#| fig.width: params$plot_width
#| fig.height: (params$plot_height + 1)
#| fig-cap: UMAP Integrated k.param = 15, resolution = 0.5.

dimplot(seurat_3, reduction = "umap", label = T, group.by = "seurat_clusters", title = "UMAP-Integrated, k.param = 15, resolution = 0.5")
```
...
dimplot(seurat_4, reduction = "umap", label = T, group.by = "seurat_clusters", title = "UMAP-Integrated, k.param = 20, resolution = 0.6")
```
k.param = 50, resolution = 0.8
```{r}
#| fig.width: params$plot_width
#| fig.height: (params$plot_height + 1)
#| fig-cap: UMAP Integrated k.param = 50, resolution = 0.8.

dimplot(seurat_5, reduction = "umap", label = T, group.by = "seurat_clusters", title = "UMAP-Integrated, k.param = 50, resolution = 0.8")
```
Clean up workspace
```{r}
rm(seurat_1, seurat_2, seurat_3, seurat_4, seurat_5)
...
dimplot(seurat, reduction = "umap", label = T, group.by = "res.0.1", title = "UMAP-Integrated, k.param = 20, resolution = 0.1")
```
...
dimplot(seurat, reduction = "umap", label = T, group.by = "res.0.2", title = "UMAP-Integrated, k.param = 20, resolution = 0.2")
```
...
dimplot(seurat, reduction = "umap", label = T, group.by = "res.0.3", title = "UMAP-Integrated, k.param = 20, resolution = 0.3")
```
...
dimplot(seurat, reduction = "umap", label = T, group.by = "res.0.5", title = "UMAP-Integrated, k.param = 20, resolution = 0.5")
```
k.param = 20, resolution = 0.6
```{r}
#| fig.width: params$plot_width
...
dimplot(seurat, reduction = "umap", label = T, group.by = "res.0.6", title = "UMAP-Integrated, k.param = 20, resolution = 0.6")
```
...
dimplot(seurat, reduction = "umap", label = T, group.by = "res.0.8", title = "UMAP-Integrated, k.param = 20, resolution = 0.8")
```
